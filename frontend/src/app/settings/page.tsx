...
export default function SettingsPage() {
  ...
  return (
    <div className="px-12 py-10">
      ...
      {/* Account details */}
      <div className="flex-1 flex flex-col min-w-[280px] rounded-2xl p-8" style={{ background: 'var(--bg1)', border: '1px solid var(--border)', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
